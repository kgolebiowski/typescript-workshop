...
var TrackSearch = (function () {
    ...
    TrackSearch.prototype.search = function (query, direction) {
        return __awaiter(this, void 0, void 0, function () {
            var url, directionUrl, response, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (direction) {
                            directionUrl = this.paginationUrl(direction);
                            if (!directionUrl) {
                                throw new Error('SpotifySearch: No direction url to query. ' +
    ...
    TrackSearch.prototype.hasDirection = function (direction) {
